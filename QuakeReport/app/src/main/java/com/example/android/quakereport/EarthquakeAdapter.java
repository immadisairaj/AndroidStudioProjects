...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView magnitudeView = listItemView.findViewById(R.id.tv_magnitude);
        ...
        TextView directionView = listItemView.findViewById(R.id.tv_direction);
        directionView.setText(locationOffset);

        TextView locationView = listItemView.findViewById(R.id.tv_location);
        locationView.setText(primaryLocation);

        Date dateObject = new Date(Long.valueOf(currentEarthquake.getDate()));
