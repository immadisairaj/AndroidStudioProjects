...
public final class QueryUtils {
    ...
    private static final String USGS_REQUEST_URL = "https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=2018-01-01&endtime=2018-08-14&limit=15";
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for (int i = 0; i < root.getJSONArray("features").length(); i++) {
                JSONObject feature = root.getJSONArray("features").getJSONObject(i).getJSONObject("properties");
                earthquakes.add(new Earthquake(formatter.format(feature.getDouble("mag")), feature.getString("place"), feature.getString("time"), feature.getString("url")));
            }
